import sys
from sqlalchemy import create_engine, Column, Integer, String, DateTime, or_, not_
...
def main():
    ...
    try:
        ...
        results = sess.query(User).filter(
            ...
            not_(User.speciality.ilike('%engineer%')),
            not_(User.position.ilike('%engineer%'))
...
if __name__ == "__main__":
    print("-" * 60)
    print("Поиск колонистов в первом модуле и не инженеров")
    print("-" * 60)
    main()
